...
/// <summary>
/// Zero-allocation read-only view over a <see cref="ValueCacheSeries"/>.
/// <para>
/// When the compile-time type is this struct, accessors can inline to the owner.
/// Consume it through generic methods constrained to <see cref="IReadOnlyValueCacheSeries"/>
/// so the JIT does not box.
/// </para>
/// <para>
/// Warning: do not cast this struct to <see cref="IReadOnlyValueCacheSeries"/>, store it in that
...
/// </para>
/// </summary>
public readonly struct ReadOnlyValueCacheSeries : IReadOnlyValueCacheSeries
{
    #region Fields

    private readonly ValueCacheSeries _Owner;
    ...
    public ReadOnlyValueCacheSeries(ValueCacheSeries owner)
    {
    ...
    /// <inheritdoc/>
    public ValueCacheSeriesHandle Handle => _Owner.Handle;
