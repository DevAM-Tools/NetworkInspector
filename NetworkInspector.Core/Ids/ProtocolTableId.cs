...
public readonly struct ProtocolTableId(int value) : IEquatable<ProtocolTableId>, IComparable<ProtocolTableId>
{
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public int CompareTo(ProtocolTableId other) => Value.CompareTo(other.Value);
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool Equals(ProtocolTableId other) => Value == other.Value;
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator <(ProtocolTableId left, ProtocolTableId right) => left.Value < right.Value;
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator >(ProtocolTableId left, ProtocolTableId right) => left.Value > right.Value;
    /// <inheritdoc/>
