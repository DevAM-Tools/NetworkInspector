...
public readonly struct PostParserId(int value) : IEquatable<PostParserId>, IComparable<PostParserId>
{
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public int CompareTo(PostParserId other) => Value.CompareTo(other.Value);
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool Equals(PostParserId other) => Value == other.Value;
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator <(PostParserId left, PostParserId right) => left.Value < right.Value;
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator >(PostParserId left, PostParserId right) => left.Value > right.Value;
    /// <inheritdoc/>
