...
public sealed partial class IPv6Protocol
{
    #region Effect types

    /// <summary>
    /// Outcome of feeding one IPv6 fragment into the defragmenter, recorded during the first parse of
    ...
    /// <summary>Records the defragmentation outcome of one IPv6 layer during its first parse.</summary>
