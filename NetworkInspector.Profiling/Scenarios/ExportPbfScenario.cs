...
/// </para>
/// </summary>
internal sealed class ExportPbfScenario : IProfilingScenario, IDisposable
{
    ...
    /// <inheritdoc/>
    public string Name => "export-pbf";

    /// <inheritdoc/>
    public string Description =>
        $"Export {BatchSize:N0} parsed IPv6/UDP packets as PBF (Standard) → MemoryStream per iteration.";
