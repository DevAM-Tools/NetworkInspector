...
/// <summary>
/// Bitfield writeback correctness for structured <see cref="SignalPduLayer"/> instances.
/// </summary>
internal sealed class SignalPduLayerWriteRoundTripTests
{
    ...
    public async Task WriteHeader_EncodesScaledLittleEndianFields()
    {
        ...
        SignalPduLayer layer = new(layout, vals);
    ...
    /// <summary>
    /// FlexRay + SignalPdu composition: the 4 signal bytes must appear at frame offset 7
    ...
    /// <summary>
    /// LIN + SignalPdu composition: the 4 signal bytes must appear at frame offset 8
